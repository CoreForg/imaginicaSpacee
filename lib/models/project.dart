class Project {
  ...
  final String? videoPath;        // asset path to MP4
  final List<String> platforms;   // e.g. ['Web', 'App', 'Admin Panel']
...
const List<Project> kProjects = [
  Project(
    ...
    techStack: ['Flutter', 'Spring Boot', 'PostgreSQL', 'REST APIs', 'Desktop', 'Node.js'],
    ...
    features: [
      ...
      'Marketing website with modern UI (live screenshots below)',
    ...
    screenshots: [
      'assets/screenshorts/supplix_web/web1.png',
      'assets/screenshorts/supplix_web/web2.png',
      'assets/screenshorts/supplix_web/web3.png',
      'assets/screenshorts/supplix_web/web4.png',
      'assets/screenshorts/supplix_web/web5.png',
      'assets/screenshorts/supplix_web/web6.png',
    ],
    videoPath: 'assets/videos/supplix_web.mp4',
  ),
  Project(
    id: 'nexus-forge',
    title: 'Nexus Forge',
    ...
    screenshots: [
      'assets/screenshorts/nexusforge/nexus1.png',
      'assets/screenshorts/nexusforge/nexus2.png',
      'assets/screenshorts/nexusforge/nexus3.png',
      'assets/screenshorts/nexusforge/nexus4.png',
      'assets/screenshorts/nexusforge/nexus5.png',
      'assets/screenshorts/nexusforge/nexus6.png',
      'assets/screenshorts/nexusforge/nexus7.png',
      'assets/screenshorts/nexusforge/nexus8.png',
    ],
    videoPath: 'assets/videos/nexusvideo.mp4',
  ),
  Project(
    id: 'expense-tracker',
    ...
    screenshots: [
      'assets/screenshorts/expensetracker/expense1.png',
      'assets/screenshorts/expensetracker/expense2.png',
      'assets/screenshorts/expensetracker/expense3.png',
      'assets/screenshorts/expensetracker/expense4.png',
      'assets/screenshorts/expensetracker/expense5.png',
      'assets/screenshorts/expensetracker/expense6.png',
      'assets/screenshorts/expensetracker/expense7.png',
      'assets/screenshorts/expensetracker/expense8.png',
    ],
  ),
  Project(
    id: 'support-system',
    ...
    screenshots: [
      'assets/screenshorts/support_system/support1.png',
    ],
  ),
  Project(
    id: 'grocery-app',
